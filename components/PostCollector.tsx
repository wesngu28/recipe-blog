        ...
        .map(({ slug, frontmatter }) => (
          ...
          >
            <Link href={`/post/${slug}`}>
              ...
              />
              <div className="top-1/2 left-1/2 text-center -translate-y-1/2 -translate-x-1/2 absolute invisible group-hover:visible hover:visible text-white font-bold text-xl">{frontmatter.title}</div>
            </Link>
          </div>
        ))
